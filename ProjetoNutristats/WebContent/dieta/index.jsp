...
<body>
  ...
  <div class="card-section">
    <p style="color: black">Café da manhã: <%=d.getCafeManha() %>   </p>
    
    
   <hr>
        <p style="color: black">Almoço: <%=d.getAlmoco() %>   </p>
        <hr>
        <p style="color: black">Café da tarde:  <%=d.getCafeTarde() %>   </p>
        <hr>
